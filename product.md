...
We are planning to build a mobile app that helps guide musicians by centralizing their songwriting and creative process. The problem that we are aiming to solve is the issue when a musician suddenly has a breakthrough or idea for a musical composition and they do not have a centralized place to record their ideas, and expand on them through lyrics, song outlining, and optional idea suggestions. In today’s day and age, most people carry around a smartphone, and having an app to assist this process would be the most accessible way to keep an idea from escaping.
...
General experience with app development specifically is low, so the interest was in an in-depth, large-scale project to sink one’s teeth into and gain experience
Comfortability with Java, leading to Android development in particular
Benefits:
Combine audio recording, lyric note taking, and suggestions into one simple app, which are usually features of multiple different apps. This is a single process yet most users need to use multiple apps to accomplish their goal.
In the moment recording and help. Great ideas can occur at any moment, and yet fade away quickly if not recorded. This app allows you to capture every single one of them
Prevent Writer’s Block. With the ability to play instruments inside the app, and to get varied lyrics suggestions, allows users to push on with their creative process and overcome obstacles.
Alternative Ideas: Activity suggestion app
It would gather a user’s interests, such as types of food, sports, hobbies, etc. and give a daily suggestion for somewhere to go based on the user’s location. For example if there was a discount at a nearby rock climbing place, and the user showed that they like extreme sports, it would give that suggestion. Another goal of the app would be to try user’s to try new things outside of their interests. The app would be slightly gamified, where users would gain points for trying out suggestions, and more points for trying things outside their interests. Overall we did not choose this idea as it was difficult to narrow down the target audience, and the exact functionality of the app. It was a good idea but lacked clarity, and we needed something we could focus on better.
